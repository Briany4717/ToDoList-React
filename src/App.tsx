...
function App() {
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      ...
      <div className='flex justify-between w-screen min-h-screen pt-16'>
        {/* Panel principal de tareas */}
        <div className='flex-1 max-w-3xl p-10'>
          <h2 className='text-2xl font-normal mb-6 text-gray-800' style={{ fontFamily: 'system-ui' }}>
            Mis Tareas
          </h2>
